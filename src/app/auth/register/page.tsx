...
import { logout, register } from "@/services/auth/authService";
...
export default function RegisterPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      // Confirm-email is off, so signUp already returned an active Supabase
      // session — sign it out again since this app's UX is register-then-login,
      // not auto-login-after-register.
      await logout();
      logoutUser();
